    ...
    return (
        ...
        <div className="md:h-screen md:grid md:grid-cols-2                                          
            ...
            <div className="pt-12 flex flex-col px-10">{/* texts */}
                ...
                <ul className="text-slate-200 list-disc pl-12">
                    ...
                    <p className="font-signature text-yellow-400 text-5xl pt-12 flex justify-center"><FormattedMessage id="svcs.10" defaultMessage="" /></p>
                
            </div>{/* texts ends*/}

            <div className="sm:ml-5">{/* pics */}

                <div className="md:grid md:grid-cols-3 md:grid-rows-3 md:gap-1 sm:flex sm:flex-wrap">
